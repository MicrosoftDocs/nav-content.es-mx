...
| App | Descripción |
| --- | --- |
| Microsoft Dynamics NAV | Proporciona un panel de control con datos financieros clave a lo largo del tiempo, como ingresos frente a gastos, margen de operación y ciclo de efectivo.|
| Microsoft Dynamics 365 for Sales | Proporciona un panel de control con datos clave sobre oportunidades de ventas y contactos.  |
| Microsoft Dynamics 365 for Sales | Proporciona un panel de control con datos clave sobre ventas e inventario. |
...
* Acceso a [!INCLUDE[d365fin](includes/d365fin_md.md)]. Consulte [Dynamics NAV](http://go.microsoft.com/fwlink/?LinkID=759714) para obtener más información.  
