...
## <a name="story"></a>Historia  
 ...
 En entornos de fabricación más complejos, se utiliza la hoja de planificación para planificar el suministro basándose en parámetros de productos como ciclo de reprogramación, plazo de seguridad, punto de reorden y cálculos por lotes de la demanda consolidada de todos los niveles de productos.  
...
4.  En la ventana **Planificación de pedidos**, considere las alternativas de planificación que tiene. En este caso, no tiene métodos de suministro alternativos, ni transferencia, ni sustituto ni entrega posterior. Debe crear el pedido de suministro sugerido: una orden de producción.  
