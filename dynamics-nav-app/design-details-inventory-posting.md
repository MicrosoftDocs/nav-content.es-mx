...
|Fecha registro|Tipo mov.|Importe costo (Real)|Cantidad|Nº mov.|  
|------------------|----------------|----------------------------|--------------|---------------|  
|01-01-20|Compra|80,00|10|1|  

 **Valor mov.**  

|Fecha registro|Tipo mov.|Importe costo (Real)|Nº mov. producto|Nº mov.|  
|------------------|----------------|----------------------------|---------------------------|---------------|  
...
|Fecha registro|Tipo mov.|Importe costo (Real)|Costo regis. en contab.|Nº mov. producto|Nº mov.|  
|------------------|----------------|----------------------------|-------------------------|---------------------------|---------------|  
|01-01-20|Costo directo|70.00|70.00|1|1|  
...
|01-01-20|[Cuenta de costo directo aplicado]|7291||-70,00|2|  
|01-01-20|[Cuenta de inventario]|2130||10.00|3|  
|01-01-07|[Cuenta liq. costos gen.]|7292||-10,00|4|  
...
>   
>  El campo **Costo regis. en contab.** de la tabla **Movimiento valor** está rellenado.  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Detalles de diseño: Componentes de costo](design-details-cost-components.md) [Administración de costos de inventario](finance-manage-inventory-costs.md)  
 [Finanzas](finance.md)  
