---
title: Uso de hojas de horas para proyectos
author: SorenGP
ms.custom: na
ms.date: 11/01/2016
ms.reviewer: na
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Hojas de horas** y, a continuación, seleccione el vínculo relacionado.
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Hojas de horas del administrador** y, a continuación, seleccione el vínculo relacionado.
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Hojas de horas del administrador** u **Hojas de horas** y, a continuación, seleccione el vínculo relacionado.
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Diario de recursos** y, a continuación, seleccione el vínculo relacionado.  
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Diario de proyectos** y, a continuación, seleccione el vínculo relacionado.  
2. Elija la acción **Sugerir líneas de hojas de horas**.  
3. Rellene los campos según sea necesario.  
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Mover hojas de horas a archivo** y, a continuación, seleccione el vínculo relacionado.  
2. Rellene los campos según sea necesario y, a continuación, cierre la ventana.  
3. Para revisar las hojas de horas archivadas, en la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Archivos de hoja de horas** o **Archivos de hoja de horas del administrador** y, a continuación, seleccione el vínculo relacionado.
