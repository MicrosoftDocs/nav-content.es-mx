...
2. Rellene los campos restantes de la línea del diario general, como el importe y el número del cliente u otra información del estado de cuenta bancaria. Para obtener más información, consulte [Registrar transacciones directamente en la contabilidad](finance-how-post-transactions-directly.md).  
