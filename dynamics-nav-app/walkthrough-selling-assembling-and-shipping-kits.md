...
-   Volver a calcular precio unitario de un producto del ensamblado personalizado.  
-   Crear una línea de pedido de venta mezclada donde partes de la cantidad de venta se proporcionan del inventario y la parte restante se debe ensamblar antes de la remisión.  
-   Descripción de los avisos de disponibilidad ATO.  

### <a name="planning-for-assembly-items"></a>Planificar para los productos de ensamblado  
...
-   Generar un pedido de ensamblado para satisfacer una cantidad de línea de venta antes de la fecha de remisión solicitada.  

### <a name="assembling-items"></a>Ensamblar productos  
Los pedidos de ensamblado funcionan de forma similar a las órdenes de producción, excepto que el consumo y la salida se graban y se registran directamente desde el pedido. Cuando los productos se ensamblan en el inventario, el trabajador del ensamblado tiene acceso completo a todos los campos de cabecera y línea. Cuando los productos se ensamblan en un pedido donde la cantidad y fecha se han prometido al cliente, determinados campos del pedido de ensamblado no se pueden editar. En ese caso, el registro del ensamblado se realiza a partir de la remisión de almacén para el pedido de venta vinculado. En esta sección se describen las tareas siguientes.  

-   Grabar y registrar el consumo y salida de ensamblado en el inventario.  
-   Acceder una línea de remisión de almacén desde un pedido de ensamblado ATO de graba el trabajo de ensamblado.  
-   Acceder a un pedido de ensamblado ATO desde una línea de remisión de almacén para revisar los datos especificados automáticamente.  

### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Enviar productos de ensamblado, desde el inventario y ensamblado para pedido  
...
-   Crear un picking de almacén para los productos de ensamblado de inventario y para los componentes de ensamblado que se deben ensamblar antes de la remisión.  
-   Registrar los pickings de almacén para los componentes del ensamblado y luego para los productos de ensamblado.  
-   Acceder a un pedido de ensamblado desde una remisión de almacén para revisar los componentes preparados o consumidos.  
-   Enviar cantidades de ensamblar para pedido.  
-   Enviar productos de ensamblado de inventario.  
...
4.  En el campo **Cód. ubic. desde ensamblado**, especifique **W-01-0001**.  
    ...
    Al especificar este código de ubicación de picking, los productos de ensamblado terminados se enviarán a la ubicación.  
...
3.  Cree el primer producto del ensamblado según la información siguiente.  
    ...
    |**Política de ensamblado**|Ensamblar para stock|  
    |**Política reorden**|Lote a lote|  

    > [!NOTE]  
    >  El kit A suele suministrarse por ensamblado para inventario y, por tanto, tiene una Política de reorden para que forme parte de la planificación de suministros general.  
...
6.  Cree el segundo productos de ensamblado según la información siguiente.  
    ...
    |**Código de categoría de artículo**|Varios|  
    |**Sistema reposición**|Ensamblado|  
    |**Política de ensamblado**|Ensamblar para pedido|  

    > [!NOTE]  
    >  El kit B suele suministrarse por ensamblado para pedido y, por tanto, no tiene directiva de reorden, ya que no debería formar parte de la planificación de suministros general.  
...
3.  Cree dos líneas de pedido de venta para el cliente 62000, La Tienda Aparatos, en la fecha de trabajo con la siguiente información.  
    ...
    |**Escriba**|**Descripción**|**Cantidad**|Cantidad a ensamblar para pedido|Fecha envío|  
    |--------------|---------------------|------------------|-------------------------------|-------------------|  
...
9. Cierre la ventana **Ensamblar para líneas de pedido**.  
    ...
    A continuación, actualice el precio unitario de venta del kit B según la personalización que acaba de realizar. Observe el valor actual en el campo **Precio unitario de venta sin IVA**.  
...
11. Elija el botón **Sí**. Observe el valor aumentado en el campo **Precio unitario de venta sin IVA**.  
...
14. En la ventana **Ensamblar para líneas de pedido**, cree una nueva línea de pedido de ensamblado con la siguiente información.  
    ...
    |Tipo|Nº|Cantidad por|  
    |----------|---------|------------------|  
    |Producto|80203|1|  

     A continuación, cambie la fecha de remisión de la segunda línea de pedido de venta según la programación del ensamblado.  
...
17. En la pestaña **Acciones**, en el grupo **Almacén**, elija **Crear remisión alm.**  
...
1.  Seleccione el icono ![Buscar página o informe](media/ui-search/search_small.png "icono Buscar página o informe"), escriba **Envío almacén** y, a continuación, seleccione el vínculo relacionado.  
...
2.  Abra la remisión de almacén más reciente que se ha creado en el almacén BLANCO.  
    ...
    A continuación, cree un documento de picking para todos los componentes del ensamblado ATO que se necesitan en la remisión de almacén.  
...
8.  Vuelva a abrir la ventana **Remisión almacén**.  
...
14. En la pestaña **Acciones**, en el grupo **Registro**, elija **Registrar remisión** y, a continuación, seleccione **Enviar**.  
...
7.  En la pestaña **Inicio**, en el grupo **Registrar**, elija **Registrar picking** y, a continuación elija el botón **Sí**.  
    ...
    Vuelva a la remisión de almacén para realizar la última tarea.  
...
9. En la pestaña **Acciones**, en el grupo **Registro**, elija **Registrar remisión** y, a continuación, seleccione **Enviar**.  
