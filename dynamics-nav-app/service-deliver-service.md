...
|**Para**|**Vea**|  
|------------|-------------|  
|Cree cotizaciones que sean borradores de pedidos de servicio y, a continuación, conviértalas en pedidos de servicio.|[Cómo crear cotizaciones de servicio](service-how-to-create-service-quotes.md)|
...
|Crear y registrar facturas para servicios entregados.|[Cómo crear una factura de servicio o una nota de crédito de servicio.](service-how-create-invoices.md)|  
