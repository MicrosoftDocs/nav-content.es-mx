...
2. Seleccione la acción **Nuevo** para crear una ficha de póliza seguro nueva. Seleccione un campo para obtener una breve descripción del campo o el enlace a información adicional.
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Diarios de seguros** y, a continuación, seleccione el vínculo relacionado.
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Ajustar valores seguros** y, a continuación, seleccione el vínculo relacionado.
...
4. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Diarios de seguros** y, a continuación, seleccione el vínculo relacionado.
...
Dynamics NAV proporciona informes dedicados y ventanas de estadísticas para usarlos en el análisis de las pólizas de seguro y saber si sus activos fijos tienen un exceso o una falta de seguro.

### <a name="overview-of-insurance-policies"></a>Resumen de pólizas de seguro  
Para obtener un resumen de sus pólizas de seguro, puede previsualizar o imprimir el informe **Seguro – Lista**, que muestra todas las pólizas y los campos más importantes de las fichas seguros.  
