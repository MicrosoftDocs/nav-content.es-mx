...
Los componentes seleccionados se conectarán a las operaciones seleccionadas cuando cree o actualice una orden de producción con la L.M. de producción y ruta en cuestión. Esta conexión se puede ver en la ventana **Componentes orden producción** bajo la orden de producción, y en esta misma ventana puede quitar y eliminar los códigos de conexión de ruta definidos cuando lo desee.
