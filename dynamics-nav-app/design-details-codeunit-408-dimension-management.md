...
---
# <a name="design-details-codeunit-408-dimension-management"></a><span data-ttu-id="45edc-103">Detalles de diseño: Gestión de dimensiones de unidad de código 408</span><span class="sxs-lookup"><span data-stu-id="45edc-103">Design Details: Codeunit 408 Dimension Management</span></span>
<span data-ttu-id="45edc-104">La gestión de dimensiones de la unidad de código 408 corresponde a una biblioteca de funciones que controla tareas comunes relacionadas con las dimensiones, como copiar desde una tabla a otra o desde un documento a otro.</span><span class="sxs-lookup"><span data-stu-id="45edc-104">Codeunit 408 Dimension Management is a function library that handles common tasks that are related to dimensions, such as copying from one table to another or from one document to another.</span></span> <span data-ttu-id="45edc-105">En este tema se enumeran las funciones que se han modificado en Microsoft Dynamics NAV 2013 R2 y se especifica qué se tiene que hacer en las funciones.</span><span class="sxs-lookup"><span data-stu-id="45edc-105">This topic lists the functions that are modified in Microsoft Dynamics NAV 2013 R2 and specifies what has to be done to the functions.</span></span> <span data-ttu-id="45edc-106">Muchas funciones se eliminan porque no es necesario realizar la copia entre tablas de dimensiones.</span><span class="sxs-lookup"><span data-stu-id="45edc-106">Many functions are deleted because there is no need for copying between dimension tables.</span></span>  

## <a name="modified-functions"></a><span data-ttu-id="45edc-107">Funciones modificadas</span><span class="sxs-lookup"><span data-stu-id="45edc-107">Modified Functions</span></span>  

|<span data-ttu-id="45edc-108">Nombre de función</span><span class="sxs-lookup"><span data-stu-id="45edc-108">Function Name</span></span>|<span data-ttu-id="45edc-109">Descripción de la modificación</span><span class="sxs-lookup"><span data-stu-id="45edc-109">Modification Description</span></span>|  
|-------------------|------------------------------|  
|<span data-ttu-id="45edc-110">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="45edc-110">CheckDimSetIDComb</span></span>|<span data-ttu-id="45edc-111">Nueva función que sustituye a otras funciones de comprobación y acepta un identificador de grupo de dimensiones como argumento en lugar de una tabla de dimensiones.</span><span class="sxs-lookup"><span data-stu-id="45edc-111">New function that substitutes the other check functions and takes a Dimension Set ID as an argument instead of a dimension table.</span></span>|  
|<span data-ttu-id="45edc-112">CheckDimSetIDComb</span><span class="sxs-lookup"><span data-stu-id="45edc-112">CheckDimSetIDComb</span></span><br /><br /> <span data-ttu-id="45edc-113">CheckDocDimComb</span><span class="sxs-lookup"><span data-stu-id="45edc-113">CheckDocDimComb</span></span><br /><br /> <span data-ttu-id="45edc-114">CheckServContractDimComb</span><span class="sxs-lookup"><span data-stu-id="45edc-114">CheckServContractDimComb</span></span><br /><br /> <span data-ttu-id="45edc-115">CheckDimBuffer</span><span class="sxs-lookup"><span data-stu-id="45edc-115">CheckDimBuffer</span></span><br /><br /> <span data-ttu-id="45edc-116">CheckDimComb</span><span class="sxs-lookup"><span data-stu-id="45edc-116">CheckDimComb</span></span><br /><br /> <span data-ttu-id="45edc-117">CheckDimValueComb</span><span class="sxs-lookup"><span data-stu-id="45edc-117">CheckDimValueComb</span></span>|<span data-ttu-id="45edc-118">Eliminar.</span><span class="sxs-lookup"><span data-stu-id="45edc-118">Delete.</span></span> <span data-ttu-id="45edc-119">Todo el uso debe cambiar a CheckDimSetIDComb.</span><span class="sxs-lookup"><span data-stu-id="45edc-119">All usage should be changed to CheckDimSetIDComb.</span></span>|  
|<span data-ttu-id="45edc-120">GetDefaultDim</span><span class="sxs-lookup"><span data-stu-id="45edc-120">GetDefaultDim</span></span>|<span data-ttu-id="45edc-121">Modificar para devolver un identificador entero de grupo de dimensiones en vez de un conjunto de registros.</span><span class="sxs-lookup"><span data-stu-id="45edc-121">Modify to return an integer Dimension Set ID instead of a set of records.</span></span>|  
|<span data-ttu-id="45edc-122">CopyJnlLineDimToICJnlDim</span><span class="sxs-lookup"><span data-stu-id="45edc-122">CopyJnlLineDimToICJnlDim</span></span><br /><br /> <span data-ttu-id="45edc-123">CopyICJnlDimToJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="45edc-123">CopyICJnlDimToJnlLineDim</span></span><br /><br /> <span data-ttu-id="45edc-124">CopyDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="45edc-124">CopyDocDimtoICDocDim</span></span><br /><br /> <span data-ttu-id="45edc-125">CopyICDocDimtoICDocDim</span><span class="sxs-lookup"><span data-stu-id="45edc-125">CopyICDocDimtoICDocDim</span></span>|<span data-ttu-id="45edc-126">Modificar para trabajar con DimSetID - > ICJnlLineDim</span><span class="sxs-lookup"><span data-stu-id="45edc-126">Modify to work with DimSetID -> ICJnlLineDim</span></span>|  

## <a name="deleted-functions"></a><span data-ttu-id="45edc-127">Funciones eliminadas</span><span class="sxs-lookup"><span data-stu-id="45edc-127">Deleted Functions</span></span>  
...
>  <span data-ttu-id="45edc-129">Durante la actualización del código de aplicación desde Microsoft Dynamics NAV 2009 o versiones anteriores a Microsoft Dynamics NAV 2016, las funciones siguientes no están disponibles en Microsoft Dynamics NAV 2016.</span><span class="sxs-lookup"><span data-stu-id="45edc-129">During the upgrade of application code from Microsoft Dynamics NAV 2009 or earlier versions to Microsoft Dynamics NAV 2016, the following functions are not available in Microsoft Dynamics NAV 2016.</span></span> <span data-ttu-id="45edc-130">Si tiene personalizaciones que utilizan una o varias de las funciones, debe actualizar ese código según corresponda.</span><span class="sxs-lookup"><span data-stu-id="45edc-130">If you have customizations that use one or more of the functions, you must upgrade that code accordingly.</span></span>
 ...
 <span data-ttu-id="45edc-144">GetDocDim</span><span class="sxs-lookup"><span data-stu-id="45edc-144">GetDocDim</span></span>  
 ...
 <span data-ttu-id="45edc-164">ShowTempDim</span><span class="sxs-lookup"><span data-stu-id="45edc-164">ShowTempDim</span></span>  
 ...
 <span data-ttu-id="45edc-184">CopySCDimToDocDim</span><span class="sxs-lookup"><span data-stu-id="45edc-184">CopySCDimToDocDim</span></span>  
 ...
 <span data-ttu-id="45edc-205">CopyJnlLineDimToBuffer</span><span class="sxs-lookup"><span data-stu-id="45edc-205">CopyJnlLineDimToBuffer</span></span>  
