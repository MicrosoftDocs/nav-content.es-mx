...
---
# <a name="how-to-lend-and-receive-loaners"></a>Prestar y recibir productos prestados
...
Cuando reciba un producto prestado de un cliente, deberá registrar la remisión. Para ello, utilice las ventanas **Pedido servicio**, **Entrega de servicio registrada** y **Ficha prod. prestado**. Este procedimiento muestra cómo recibir productos prestados en la ventana **Pedido servicio**.  
