...
**Nota**: El contenido de los campos que haya seleccionado en la sección **Herencia** de la ventana **Configuración de marketing** se copia de la empresa a las personas de esa empresa.

##<a name="see-also"></a>Consulte también
[Configurar la gestión de marketing y contactos](marketing-setup-marketing.md)  
[Configurar grupos de correo en contactos](marketing-mailing-groups.md#assign-mailing-groups-to-a-contact)
