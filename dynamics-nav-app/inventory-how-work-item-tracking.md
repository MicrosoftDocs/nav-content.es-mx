...
Con el fin de mejorar el rendimiento, el programa recopila la información sobre disponibilidad que se muestra en la ventana **Líns. seguim. prod.** solamente cuando la abre. Esto significa que el sistema no actualiza la información de disponibilidad durante el tiempo que esté abierta la ventana, incluso aunque se produzcan cambios en el inventario o en otros documentos.
...
2.  En la ficha desplegable **Varios**, seleccione las casillas de verificación siguientes.  
    ...
    |**Entr. manual fecha cad. req.**|Especifica que debe introducirse manualmente una fecha de caducidad en la línea de seguimiento de producto.|  
...
3.  En la ventana **Líns. seguim. prod.**, dispone de tres opciones para especificar el número de serie o de lote:  
    ...
    -   Seleccione la acción **Selec. movs.** La ventana **Seleccionar movs.** mostrará todos los números de serie o de lote junto con su información de disponibilidad.
