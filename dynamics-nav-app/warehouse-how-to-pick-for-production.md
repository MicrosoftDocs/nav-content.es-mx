...
En configuraciones avanzadas de almacén, donde las ubicaciones requieren tanto picking como envíos, utilice la ventana **Picking almacén** para llevar los componentes a las órdenes de producción o a los pedidos de ensamblado.
...
La ventana **Picking de inventario** también se utiliza para realizar el picking y envíos para ventas cuando los productos se deben ensamblar antes de que se puedan enviados. Para obtener más información, consulte [Procedimiento: Venta de artículos ensamblados para pedido](assembly-how-to-sell-items-assembled-to-order.md).
...
Puede crear el documento de picking de almacén mediante inserción seleccionando la acción **Crear picking alm.** en el documento de origen, como un pedido de ensamblado enviado o un envío de almacén. Para obtener más información, vea [Cómo realizar picking de productos con picking almacén](warehouse-how-to-pick-items-for-warehouse-shipment.md).  
