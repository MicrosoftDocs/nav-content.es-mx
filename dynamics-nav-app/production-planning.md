...
|Utilizar la ventana **Programación de pedidos** para planificar manualmente un nivel de L.MAT. de producción a la vez para la demanda de ventas o producción.|[Procedimiento: Planificar la nueva demanda de pedido por pedido](production-how-to-plan-for-new-demand.md)|
