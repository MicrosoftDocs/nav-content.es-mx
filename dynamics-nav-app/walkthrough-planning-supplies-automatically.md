...
3.  En la ventana **Crear unidad de almacenam.**, deje todas las opciones y filtros sin cambiar y, a continuación, haga clic en el botón **Aceptar**.  
...
4.  En la ventana **Lista unidad de almacenam.**, abra la ficha Unidad de almacenam. AZUL.  
...
3.  En la ventana **Ejecutar mensajes acción-Plan.**, rellene los campos descritos en la tabla siguiente.  
    ...
    |Orden de producción|Pedido compra|Pedido transferencia|  
    |----------------------|--------------------|--------------------|  
