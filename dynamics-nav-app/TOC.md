...
### [Procedimiento: crear y publicar un servicio web](across-how-publish-web-service.md)
...
### [Procedimiento: Trabajar con unidades de medida de lote de fabricación](production-how-to-use-the-manufacturing-batch-unit-of-measure.md)
...
### [Definir anticipos](finance-set-up-prepayments.md)
### [Cómo crear facturas de anticipo](finance-how-to-create-prepayment-invoices.md)
### [Cómo corregir anticipos](finance-how-to-correct-prepayments.md)
...
### [Procedimiento: Administración de costos de inventario y de fabricación](finance-handle-inventory-and-manufacturing-costs.md)
...
## [Imprimir un aviso de pago](finance-how-to-print-remittance-advice.md)
...
## [Procedimiento: configurar y publicar un servicio web KPI que se basa en estructuras de cuentas](bi-how-to-set-up-and-publish-kpi-web-services-based-on-account-schedules.md)
...
## [Procedimiento: Planifique las órdenes de proyecto](production-how-to-plan-project-orders.md)
...
## [Procedimiento: Cotización de una venta de ensamblar para pedido](assembly-how-to-quote-an-assemble-to-order-sale.md)
...
## [Tutorial: recepción y ubicación en la configuración avanzada de almacén](walkthrough-receiving-and-putting-away-in-advanced-warehousing.md)
