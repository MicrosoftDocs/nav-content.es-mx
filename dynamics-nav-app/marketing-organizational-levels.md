...
## <a name="define-an-organizational-level-code"></a>Definir un código de nivel de organización
...
1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Niveles de organización** y, a continuación, seleccione el enlace relacionado.
...
## <a name="assign-organizational-levels-to-a-contact-person"></a>Asignar niveles de organización a una persona de contacto
