...
### <a name="to-set-up-your-bank-account-for-sepa-direct-debit"></a>Configuración del banco para el adeudo directo SEPA  
...
### <a name="to-set-up-the-customers-payment-method-for-sepa-direct-debit"></a>Configuración de la forma de pago del cliente para el adeudo directo SEPA  
