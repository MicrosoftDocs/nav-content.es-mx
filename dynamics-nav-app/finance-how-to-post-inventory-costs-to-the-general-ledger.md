...
---
# <a name="how-to-reconcile-inventory-costs-with-the-general-ledger"></a>Conciliar costos de inventario con la contabilidad general
...
La contabilización automática de costos se define en el campo **Variación existencias automát.** en la ventana **Configuración de inventario**.
