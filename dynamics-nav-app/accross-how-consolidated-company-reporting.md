...
Si tiene más de una empresa en [!INCLUDE[d365fin](includes/d365fin_md.md)], el informe de balance provisional consolidado del Área de tareas Contador puede darle un resumen de la salud financiera del total de sus empresas.  
...
Si su unidad de negocio utiliza una divisa extranjera debe especificar el tipo de cambio que debe utilizarse en la consolidación. También debe introducir la información de consolidación en las cuentas de la empresa. Estos procesos se describen en las siguientes secciones.
...
|---|---|
|Tipo de cambio medio (manual) | Calcule manualmente el tipo de cambio medio para el periodo que se va a consolidar. Calcule aa media aritmética o aproximada y especifique el resultado para cada unidad de negocio. Usado para cuenta de balance de ingresos.| 
...
1. Inicie sesión en la empresa consolidada.  
2. En el **Área de tareas Contador**, seleccione la acción **Ejecutar consolidación**.  
