...
9. En el campo **Importe a liquidar**, introduzca el importe con el que desea liquidar el movimiento. Si no especifica ningún importe, se usa el importe máximo.
...
10. Elija el botón **Aceptar**. La ventana **Diario de recibos de efectivo** ahora muestra el movimiento que ha seleccionado en los campos **Liq. por tipo documento** y **Liq. por n.º documento**.
...
10. En cada línea del campo **Importe a liquidar**, introduzca el importe con el que desea liquidar cada movimiento. Si no especifica ningún importe, se usa el importe máximo.
...
5. Elija el botón **Aceptar**. La ventana **Nota de crédito de venta** ahora muestra el movimiento que ha introducido en los campos **Liq. por tipo documento** y **Liq. por n.º documento**. Asimismo, muestra el importe de la nota de crédito que se va a registrar, ajustado con los posibles descuentos por pronto pago.
