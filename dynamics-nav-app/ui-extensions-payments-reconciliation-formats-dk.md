...
> [!Note]
> Para utilizar la extensión, es necesario conocer el formato que el banco o proveedor requiere. Algunos bancos o proveedores ofrecen esta información en las páginas web; sin embargo, es posible que deba ponerse en contacto con su servicio de atención al cliente para obtener la información.  
...
|¿Se permiten los mensajes al destinatario? | Sí |N.º |N.º | Sí |
...
4. En el campo **Referencia de pago**, introduzca el número de 15 dígitos de la factura del proveedor. 
    ...
    > [!Tip]
    > Tiene que agregar solo los 11 últimos dígitos del número. Dynamics NAV añadirá cuatro ceros al comienzo del número.  
