...
1.  Puede agregar, eliminar o reorganizar columnas de dos formas:
    ...
    -   Elija con el botón secundario del mouse en un encabezado de columna y, a continuación, seleccione **Elegir columnas**.
...
2.  Elija con el botón secundario en el vínculo y elija una de las siguientes opciones (solo estará disponible una).  
