---
title: "Cómo configurar proyectos"
author: SorenGP
ms.custom: na
ms.date: 11/01/2016
ms.reviewer: na
...
1. En la esquina superior derecha, elija el icono **Buscar página o informe**, escriba **Configuración de proyectos** y, a continuación, seleccione el vínculo relacionado.
...
**Nota**: Se deben configurar las cuentas necesarias del plan de cuentas antes configurar los grupos contables. Para obtener más información, vea [Configuración o cambio del plan de cuentas](finance-setup-setup-chart-accounts.md).  

1. En la esquina superior derecha, seleccione el icono **Buscar página o informe**, escriba **Grupos contables proyectos** y, a continuación, seleccione el vínculo relacionado.  
...
|**Cta. costes acumulados trabajo en curso**|Es una cuenta del método de valor de costo o valor de ventas para el cálculo del trabajo en curso, y es una cuenta de pasivo de gastos acumulados de balance. En ella se realizarán registros cuando el ajuste del trabajo en curso exija el aumento de los costos de utilización registrados en el resultado.|  
